...
annotations = '19-392_run2_annotations.xls'
file_name = '19-392 run2 bio2.xls' # path to file + file name
...
peak_threshold = np.sqrt(np.mean(np.square(I_norm))) * 0.5
#plot raw data
...
if Analyze_tonic == True:
	...
	n,s,a=timelist_(tm2,lb2,t1,t2,data_acquisition_rate)
